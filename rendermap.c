...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/10 18:24:04 by rakkaya           #+#    #+#             */
/*   Updated: 2022/08/10 18:24:06 by rakkaya          ###   ########.tr       */
/*                                                                            */
/* ************************************************************************** */
...
void	file_to_image(t_win *win)
{
	...
	win->bg = mlx_xpm_file_to_image(win->mlx,
			"./xpm/bg.xpm", &win->chr->size, &win->chr->size);
	...
	win->wall = mlx_xpm_file_to_image(win->mlx,
			"./xpm/wall.xpm", &win->chr->size, &win->chr->size);
